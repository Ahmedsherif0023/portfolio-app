    ...
    <div className="home-container">
      ...
      <div className="h-container">
        ...
        <div className="main flex-center">
          <div className="main-h1">
            <h1>Hey, I'm Ahmed Sherif</h1>
            <h2>
              I’m a senior <strong>React.js developer , </strong>
              creates <strong>responsive</strong> web apps
            </h2>
      ...
      <div className="facts">
        <div className="facts-img">
          <img src={me} alt="my first image" className="me1" />
        ...
        <div className="facts-txt">
          ...
          <br />
          <p>
            I craft sleek, high-performance web interfaces with React.js |
            turning ideas into interactive, user-friendly experiences that bring
            your vision to life.
          </p>
          <ul className="facts-list">
            <li>
              <img src={book} alt="book-icon" />{" "}
              <p> Studied computer Science on my own</p>
            </li>
            <li>
              <img src={browser} alt="browser-icon" />
              <p>
                {" "}
                Started building front-end as a hobby but it turned to a job
              </p>
            </li>
            <li>
              <img src={tag} alt="tag-icon" />
              <p>Love Turning Ideas into life through coding</p>
            </li>
            <li>
              <img src={weight} alt="weight-icon" />
              <p>When I’m not coding I’m lifting at the GYM</p>
            </li>
          </ul>
        </div>
      </div>
      <div className="call-div">
        <div className="call-txt">
          ...
          <div className="call-image">
            {" "}
            <img src={mine} alt="my-photo" />
          </div>
        </div>

        <div className="call-btn">
          <a
            href="https://cal.com/ahmed-sherif-tg2x15"
            target="_blank"
        ...
        <div className="btn-container">
          ...
          <div className="call-btn">
            <a href="https://wa.me/+201274375560" target="_blank">
              <div className="call-btnn">
                <img src={whatsapp} alt="" className="call-imgg" />
                Whatsapp
              </div>
            </a>
          </div>
